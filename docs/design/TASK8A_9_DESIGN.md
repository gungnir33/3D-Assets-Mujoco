...
状态：用户已确认本设计及两份计划，选择方式 1 顺序实施。设计保留为契约，实际结果见 [8A 实施报告](TASK8A_IMPLEMENTATION_REPORT.md)、[任务 9 实施报告](TASK9_IMPLEMENTATION_REPORT.md)。原设计日期 2026-09-21；文中未来式示例是规划时表述，当前入口以使用说明和实施报告为准。
