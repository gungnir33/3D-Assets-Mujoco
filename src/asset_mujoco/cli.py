...
def main(argv=None):
    ...
    convert.add_argument("--collision-mode",choices=["hull","none","supplied"],default="hull")
    convert.add_argument('--collision-proxy', dest='collision_proxy_path', type=Path)
    convert.add_argument('--validation-collision-part', type=int)
